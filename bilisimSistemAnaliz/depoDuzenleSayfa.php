        ...
        <div class="container">
          <section class="content">
            <div class="card">
              ...
              <button type="button" id="ekle" class="btn btn-primary mx-auto col-3 my-1" onclick="depoEkle()">
                EKLE
              </button>
              <button type="button" id="duzenle" class="btn btn-warning mx-auto col-3 my-1" onclick="depoDuzenle()">
                DÜZENLE
              </button>
              <button type="button" id="sil" class="btn btn-danger mx-auto col-3 my-1" onclick="depoSil()">
                SİL
              </button>
              <script>
                function depoEkle() {
