        ...
        <div class="sb-sidenav-menu">
          <div class="nav">
            ...
            <a class="nav-link" href="yoneticiDuzenleSayfa.php">
              <div class="sb-nav-link-icon">
                <i class="fa fa-user-tie" style="color:blue"></i>
              </div>
              Yönetici Düzenle
            </a>
        ...
        <div class="container">
          <section class="content">
            <div class="card">
              ...
              <button type="button" id="ekle" class="btn btn-primary mx-auto col-3 my-1" onclick="yoneticiEkle()">
                EKLE
              </button>
              <button type="button" id="duzenle" class="btn btn-warning mx-auto col-3 my-1" onclick="yoneticiDuzenle()">
                DÜZENLE
              </button>
              <button type="button" id="duzenle" class="btn btn-danger mx-auto col-3 my-1" onclick="yoneticiSil()">
                SİL
              </button>
