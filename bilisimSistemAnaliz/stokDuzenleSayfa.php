        ...
        <div class="sb-sidenav-menu">
          <div class="nav">
            ...
            <a class="nav-link" href="stokDuzenleSayfa.php">
              <div class="sb-nav-link-icon">
                <i class="fa fa-box-open" style="color:blue"></i>
              </div>
              Stok Düzenle
            </a>
            <div class="collapse" id="collapsePages" aria-labelledby="headingTwo" data-bs-parent="#sidenavAccordion">
        ...
        <div class="container">
          <section class="content">
            <div class="card">
              ...
              <button type="button" id="duzenle" class="btn btn-primary mx-auto col-3 my-1" onclick="stokDuzenle()">
                STOK MİKTARINA EKLEME YAP
              </button>
              <button type="button" id="duzenle" class="btn btn-danger mx-auto col-3 my-1" onclick="stokSil()">
