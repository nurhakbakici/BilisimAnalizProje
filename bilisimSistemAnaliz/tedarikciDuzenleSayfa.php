        ...
        <div class="sb-sidenav-menu">
          <div class="nav">
            ...
            <a class="nav-link" href="tedarikciDuzenleSayfa.php">
              <div class="sb-nav-link-icon">
                <i class="fa fa-boxes-packing" style="color:blue"></i>
              </div>
              Tedarikçi Düzenle
            </a>
        ...
        <div class="container">
          <section class="content">
            <div class="card">
              ...
              <button type="button" id="ekle" class="btn btn-primary mx-auto col-3 my-1" onclick="tedarikciEkle()">
                EKLE
              </button>
              ...
              <button type="button" id="sil" class="btn btn-danger mx-auto col-3 my-1" onclick="tedarikciSil()">
                SİL
              </button>
              <script>
